...
void test() {
    ...
    Prop3DAcoVTIDenQ_DEO2_FDTD *op = new Prop3DAcoVTIDenQ_DEO2_FDTD(freeSurface, 
    ...
    op->applyFirstDerivatives3D_PlusHalf_Sandwich(freeSurface, nx, ny, nz, nthread,
        1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, inPG1, inPG2, inPG3, inMG1, inMG2, inMG3, fieldEps, fieldEta, fieldVsVp, fieldBuoy, outPG1, outPG2, outPG3, outMG1, outMG2, outMG3, nbx, nby, nbz);
    ...
    op->applyFirstDerivatives3D_MinusHalf_TimeUpdate_Linear(freeSurface, nx, ny, nz, nthread,
        1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, inPG1, inPG2, inPG3, inMG1, inMG2, inMG3, fieldVel, fieldBuoy, dtOmegaInvQ, pCur, mCur, pOld, mOld, nbx, nby, nbz);
    op->applyFirstDerivatives3D_PlusHalf(freeSurface, nx, ny, nz, nthread,
        1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, inPG1, inPG2, inPG3, outPG1, outPG2, outPG3, nbx, nby, nbz);
    op->applyFirstDerivatives3D_MinusHalf(freeSurface, nx, ny, nz, nthread,
        1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, inPG1, inPG2, inPG3, outPG1, outPG2, outPG3, nbx, nby, nbz);
