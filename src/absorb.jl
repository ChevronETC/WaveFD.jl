...
function setup_q_profile_2D_threaded!(w_inv_q::Array{T,2}, freesurface, nsponge::Int64, 
    ...
    function compute_w_inv_q!(w_inv_q::Array{T,2}, qprof::Array{T,1}, freesurface::Bool, nsponge::Int64, q_freq::T, q_interior::T) where T<:Float32
        nz,nx = size(w_inv_q)
    ...
    compute_w_inv_q!(w_inv_q, qprof, freesurface, nsponge, q_freq, q_interior)
end
