# WaveFD.jl contributor guidelines

## Issue reporting
If you have found a bug in WaveFD.jl or have any suggestions for changes to
WaveFD.jl functionality, please consider filing an issue using the GitHub
...
git:
  1. fork the WaveFD.jl repository
  ...
  4. run `]test WaveFD` in the `test` folder
